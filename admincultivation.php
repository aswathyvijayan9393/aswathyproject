        ...
        <div class="wrap pad-3">
          <div class="block-5">
            ...
            <div class="map img-border">
             <img src="images/cul.jpg" width="270" height="187"/>
            </div>
           
          </div>
          <div class="block-6">
            <h3><font color="#FF0000">Add Cultivation Methods</font></h3>
            <form id="form1" action="" method="post" enctype="multipart/form-data">
            <table width="477" height="478" border="0">
  <tr>
    <th height="49" scope="row">Method Name</th>
...
if(isset($_POST['register']))
{
	...
	$ins=mysql_query("insert into tblcultivation(name,details,photo,crop) values('$name','$details','$photo','$crop')");//insert crop cultivation details into tblcultivation 
