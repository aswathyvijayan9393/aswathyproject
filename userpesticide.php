...
<div class="main">
    ...
    <div class="container_12">
      <div class="grid_12">
        <div class="wrap pad-3">
          ...
          <div class="block-6">
             <h3><font color="#33CC99">Both Organic and Chemical Pesticides for your Crops</font></h3>
            <form id="form1" action="" method="post">
            <?php
			$query=mysql_query("select *from tblpesticide");//select pesticides details from tblpesticides
			?>
  ...
  while($r=mysql_fetch_row($query))
  {
   ...
   echo "<tr>
    ...
    <th>$r[3]</th>
   <th>$r[4]</th>
  </tr>";//fetch and print pesticides details
  }
  ?>
</table>
