      ...
      <div class="grid_12">
        <div class="wrap pad-3">
          ...
          <div class="block-6">
            ...
            <?php
			$query=mysql_query("select *from tblloan");
			?>
            <table width="383" border="1">
  <tr>
    
    <th><font color="#FF0000"><i></i>Name</font></th>
    <th><font color="#FF0000"><i>contactno</i></font></th>
    <th><font color="#FF0000"><i>reason</i></font></th>
    <th><font color="#FF0000"><i>Accountno</i></font></th>
