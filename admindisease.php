        ...
        <div class="wrap pad-3">
          <div class="block-5">
            ...
            <div class="map img-border">
             <img src="images/dis.jpg" width="270" height="187"/>
            </div>
           
          </div>
          <div class="block-6">
            <h3><font color="#FF0000">Crop Diseases</font></h3>
            <form id="form1" action="" method="post" enctype="multipart/form-data">
            <table width="477" height="478" border="0">
  <tr>
    <th height="49" scope="row">Disease_Name</th>
    <td><input name="name" type="text" required ></td>
  </tr>
  <tr>
    <th scope="row" height="49">Crop_Affect</th>
    <td><input name="crop" type="text" required ></td>
  </tr>
  <tr>
    <th scope="row" height="49">Symptoms</th>
...
if(isset($_POST['register']))
{
	...
	$ins=mysql_query("insert into tbldisease(disease,details,crop,photo) values('$name','$details','$crop','$photo')");//insert crop disease details into tbldisease
