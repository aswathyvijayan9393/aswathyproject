...
<div class="main">
    ...
    <div class="container_12">
      <div class="grid_12">
        <div class="wrap pad-3">
          ...
          <div class="block-6">
           <h3><font color="#339999">Crop diseases</font></h3>
            <form id="form1" action="" method="post">
            <?php
			$query=mysql_query("select *from tbldisease");//select fertilizer detail from tblfertilizer
			?>
            <table width="500" border="1">
  <tr><thead>
    <th scope="row"><font color="#FF0000"><i>Name</i></font></th>
    <th><font color="#FF0000"><i>Catagory</i></font></th>
    <th><font color="#FF0000"><i>Details</i></font></th>
    <th><font color="#FF0000"><i>Crop</i></font></th></thead>
  </tr>
  <?php
  while($r=mysql_fetch_row($query))
  {
   ...
   echo "<tr>
    <td><img src='upload/$r[4]' width='100' height='100'></td>
    <td>$r[1]</td>
    <td>$r[2]</td>
   <td>$r[3]</td>
  </tr>";//fetch and print fertilizer details
  }
  ?>
</table>
