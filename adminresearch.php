...
<div class="main">
        ...
        <div class="wrap pad-3">
          <div class="block-5">
            ...
            <div class="map img-border">
             <img src="images/re.jpg" width="270" height="187"/>
            </div>
           
          </div>
          <div class="block-6">
            <h3><font color="#FF0000">Add Research Institute</font></h3>
  ...
  <tr>
    <th scope="row" height="49">Place</th>
    <td><input name="crop" type="text" required ></td>
  </tr>
   <tr>
    <th scope="row" height="49">Specialisation</th>
    <td><input name="sp" type="text" required ></td>
  </tr>
  <tr>
  ...
  <tr>
    <th scope="row" height="49">Photo</th>
...
if(isset($_POST['register']))
{
	...
	move_uploaded_file($_FILES['photo']['tmp_name'],getcwd()."\\upload\\$photo");//move and upload photo in to folder and db
	
	$ins=mysql_query("insert into tblresearch(name,place,details,photo,specialization) values('$name','$crop','$details','$photo','$spec')");//add research institutes data in to tblresearch
