...
<div class="main">
    ...
    <div class="container_12">
      <div class="grid_12">
        <div class="wrap pad-3">
          ...
          <div class="block-6">
           <h3><font color="#FF0000">Season Based Cultivation</font></h3>
            <form id="form1" action="" method="post">
            <?php
			$query=mysql_query("select *from tblseason");//select  season details from tblseason
			?>
            <table width="576" height="59" border="1">
  <tr><thead>
    <th scope="row"><font color="blue"><i>Season_Name</i></font></th>
    <th><font color="blue"><i>Sowing_Season</i></font></th>
    <th><font color="blue"><i>Harvesting_Season</i></font></th>
    <th><font color="blue"><i>Best_Crop</i></font></th></thead>
  </tr>
  <?php
  while($r=mysql_fetch_row($query))
  {
   ...
   echo "<tr>
    ...
    <th>$r[3]</th>
   <th>$r[4]</th>
  </tr>";//fetch and print season details
  }
  ?>
</table>
