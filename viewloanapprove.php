    ...
    <div class="container_12">
      <div class="grid_12">
        <div class="wrap pad-3">
          ...
          <div class="block-6">
            <h3><font color="#FF0000">View Loan Approval</font></h3>
            <form  action="" method="post" enctype="multipart/form-data">
           <table border="1">
		   <tr><thead bgcolor="#999999"><th>Photo</th><th>Name</th><th>Reason</th><th>Bank_Name</th><th>Annual</th></thead></tr>
		    <?php
			$query=mysql_query("select * from tblloan where status='1' and username='$username'");//select only species from tblcrops
			while($s=mysql_fetch_array($query))
			{
			echo "<tr><td><img src='upload/$s[2]' width='70' height='70'></td><td>$s[3]</td><td>$s[10]</td><td>$s[14]</td><td>$s[16]</td></tr>";
