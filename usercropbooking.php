...
<div class="main">
    ...
    <div class="container_12">
      <div class="grid_12">
        <div class="wrap pad-3">
          ...
          <div class="block-6">
            <h3><font color="#339999">Book Crops</font></h3>
            <form id="form1" action="" method="post">
            <?php
			$query=mysql_query("select *from tblcrops");//select from crop details  from  tblcrops
			?>
            <table width="383" border="1">
  <tr><thead>
    <th scope="row"><font color="#FF0000"><i>Crop Name</i></font></th>
    <th><font color="#FF0000"><i>Species</i></font></th>
    <th><font color="#FF0000"><i>Booking</i></font></th></thead>
  ...
  while($r=mysql_fetch_row($query))
  {
   ...
   echo "<tr>
    <th scope='row'>$r[1]</th>
    <th>$r[2]</th>
    <th><a href='usercropbooking1.php?cid=$r[0]'>Book</a></th>
   
  </tr>";//fetch crop details and print
  }
  ?>
</table>
