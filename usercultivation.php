...
<div class="main">
    ...
    <div class="container_12">
      <div class="grid_12">
        <div class="wrap pad-3">
          ...
          <div class="block-6">
            <h3><font color="#339999">Cutivation Methods</font></h3>
            <form id="form1" action="" method="post">
            <?php
			$query=mysql_query("select *from tblcultivation");//select cultivation details from tblcultivation
			?>
            <table width="383" border="1">
  <tr><thead>
    <th scope="row"><font color="#FF0000"><i>Method</i></font></th>
  ...
  while($r=mysql_fetch_row($query))
  {
   ...
   echo "<tr>
    <th scope='row'>$r[1]</th>
    <th>$r[4]</th>
    <th><a href='usercultivation1.php?cmid=$r[0]'>View Details</a></th>
   
  </tr>";//fetch and print cultivation detail
  }
  ?>
</table>
