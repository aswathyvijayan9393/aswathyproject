      ...
      <div class="grid_12">
        <div class="wrap pad-3">
          ...
          <div class="block-6">
           ...
           <table border="1">
		   <tr><thead bgcolor="#999999"><th>Crop name</th><th>Quantity</th><th>Species</th><th>Season</th><th>Region</th></thead></tr>
		    <?php
			$query=mysql_query("select * from tblcropbook where status='approve' and name='$username'");//select only species from tblcrops
			while($s=mysql_fetch_array($query))
			{
			echo "<tr><td>$s[7]</td><td>$s[3]</td><td>$s[8]</td><td>$s[9]</td><td>$s[10]</td><br/></tr>";
