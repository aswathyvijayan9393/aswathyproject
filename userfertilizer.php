    ...
    <div class="container_12">
      <div class="grid_12">
        <div class="wrap pad-3">
          ...
          <div class="block-6">
           <h3><font color="#339999">Both Organic and Chemical Fertilizers for your Farming</font></h3>
            <form id="form1" action="" method="post">
            <?php
			$query=mysql_query("select *from tblfertilizer");//select fertilizer detail from tblfertilizer
			?>
            <table width="483" border="1">
  <tr style="width:auto"><thead>
